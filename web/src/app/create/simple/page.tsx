            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="text-center space-y-3 sm:space-y-4 px-2 sm:px-4">
                ...
                <p className="text-muted-foreground text-xs sm:text-sm md:text-base max-w-2xl mx-auto px-2">
                  Minimal design with clean colors and indicators. Perfect for modern brands.
                </p>
              </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                      {Object.keys(themes).map((theme) => (
                        <button
                          ...
                          className={`px-2 py-2 text-xs font-bold border rounded-lg transition-all ${
                            config.theme === theme
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                          <input
                            ...
                            className="w-8 h-8 sm:w-10 sm:h-10 rounded border-2 border-border cursor-pointer flex-shrink-0"
                          />
                          <input
                            type="text"
                            value={config.primaryColor}
                            onChange={(e) => updateConfig('primaryColor', e.target.value)}
                            className="flex-1 px-2 py-1 text-xs font-mono border border-border rounded bg-background w-full min-w-0"
                          />
                        </div>
                      </div>
